...
process bowtie {
    ...
    python /NGStools/renamePE_samtoolsFASTQ.py -1 ${fastq_id}_unmapped_1.fq -2 ${fastq_id}_unmapped_2.fq
...
/**
    ...
    #bowtie2 -x src/bowtie_index/hg19 -1 ${fastq_pair[0]} -2 ${fastq_pair[1]} -p 3 > $fastq_id.bam
